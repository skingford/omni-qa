...
const notifyTypeLabel = computed(() =>
  props.notify.type === 'email' ? t('notificationCard.email') : t('notificationCard.dingtalk'),
)
</script>
  ...
  <section class="notify-card">
    <div class="card-head">
      ...
      <div class="card-head-actions">
        <span class="card-badge">{{ notifyTypeLabel }}</span>
    ...
    <div v-if="props.notify.type === 'dingtalk'" class="card-section">
      <div class="grid two">
        <div class="field">
